...
mpg %>%
  filter(class == "midsize" | class == "minivan") %>%
  ggplot(aes(displ, hwy, color = class)) + 
  geom_point() +
  scale_color_manual(values = c("midsize" = "darkgreen", "minivan" = "purple"))
```
...
mpg <- mpg %>%
  mutate(manufacturer = fct_relevel(manufacturer, "dodge", "toyota", "volkswagen", "ford", "chevrolet", "audi",  "subaru",  "hyundai", "nissan", "honda", "jeep", "pontiac", "mercury", "land rover", "lincoln"))
